...
CONNECTION_STRING='HostName=issec-iot.azure-devices.net;DeviceId=car;SharedAccessKeyName=iothubowner;SharedAccessKey=M+5EMgJ/aZJe/Zq3AveMiwRDEr4B8wlm2O1fdgZzoco='
...
def run_telemetry_sample(client):
    ...
    xx = {"ScenarioUser": {}, "ScenarioSquare": {}}
    msg_txt_formatted = json.dumps(xx)
